...
<body>
	<ul>
		...
		<li><a href="logout"
			style="border-left-width: 100px; margin-left: 1200px;">Logout</a></li>
				...
				<table style="width: 70%" id="example" class="sortable">
					...
					<% 	int id =  0;
							...
							for(Orders o :orderList)
							{
								...
								int itemId = o.getOrdersId().getItem_Id();
								...
								%>
					<tr>
						<td><%=o.getOrdersId().getOrder_Id()%></td>
						<td><%=o.getOrder_Time()%></td>
						<td><%=o.getFulfillment_Starttime()%></td>
						<td><%=o.getReady_Time()%></td>
						<td><%=o.getPickup_Time()%></td>
						<td><%=itemName %></td>
						<td><%=o.getItem_Quantity()%></td>
						<td><%=o.getOrder_Total()%></td>
